...
function getDimensions(x,y){
  ...
  allData.forEach(function(d){
    ...
    var pair = {x: d[x], y: d[y], city: d["city"], year: d["year"], wind_mph: d["wind_mph"], storm: d["storm"], storm: d["change_gyration_percent"], storm: d["gyration_normalized"]};
...
$( document ).ready(function() {
  d3.csv("../charts/data/all_summary_flat.csv",function(data){
    ...
    data.forEach(function(d) {
        ...
        d.change_gyration_percent = +d.change_gyration_percent;
        d.gyration_normalized = +d.gyration_normalized;
    ...
    // 
    updateChart("wind_mph","change_gyration_percent","year");
  });
});
